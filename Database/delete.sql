...
delete from submission.EvidenceSubmission where user_Id = (select uId from user.Userlb where email = 'jarinya.pimm2@gmail.com') and mc_id = 'de594c8d-5d5b-4885-95d0-5425f727c74e' and submitted = 1;
